		...
		<PageContainer>
			...
			<Summary>
				...
				<SummaryParagraph>
					...
					Connecticut, USA. My superpower is learning, whether
					it&apos;s tech, music production, or linguistics—I love the
					rush of discovery and solving problems.
				</SummaryParagraph>
				...
				<SummaryParagraph>
					...
					with <AttentionText>React</AttentionText> and{" "}
			...
			<Projects>
				...
				>
					...
					addition to a custom CMS backend for school staff to update
					website content — now maintained by other students.
				</Project>
			</Projects>
